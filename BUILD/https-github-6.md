...
https://github.com/stoner4kt/AmaZulu-Prime-Solutions-LIVE/tree/main You are an expert technical writer and senior software architect specializing in high-quality software documentation for web applications, websites, and full systems.
...
Q: The site references Netlify (data-netlify form + _redirects file). Is Netlify the actual/confirmed hosting platform?
A: Yes, confirmed Netlify

Q: How should I treat the business/contact details (phone, email, address, BEE status) baked into the HTML?
A: Document them as-is (public site content)

Q: Ready for me to generate the full AAA-grade documentation now with these clarifications, or do you want to review/edit anything else first (e.g. add a README, confirm the GA ID isn't a placeholder)?
A: Proceed now, generate full docs
