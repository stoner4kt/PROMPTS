# I'm referring to stoner4kt/ToursystemV1 why does it say this when I try

I'm referring to stoner4kt/ToursystemV1 why does it say this when I try to upload my documents

---

I'm using cloudinary with edge functions, scan my repo stoner4kt/ToursystemV1

---

I added the policies but its still giving that error

---

Analyze the repo and tell me

---

Find my repo stoner4kt/ToursystemV1 and Analyze it and get back to me with the fix for this issue

---

I have that policies on my table and I only have a bookings table not a bookings_documents table I have a column though and it's json and also another place where it uploads also a column in the bookings table iternary_url

---

All my uploads are failing and here is my sql schema : --
...
CREATE TABLE public.otp_verifications (
    ...
    CONSTRAINT otp_verifications_resource_type_check CHECK ((resource_type = ANY (ARRAY['recon_edit'::text, 'booking_edit'::text, 'booking_delete'::text, 'expense_approval'::text])))
);
...
--
-- Name: profiles profiles_self; Type: POLICY; Schema: public; Owner: postgres
--
...
This is the error my console gives

---

POST https://api.cloudinary.com/v1_1/dzf97vyjs/ app.js:1944 auto/upload 403 (Forbidden)

---

I'm using a signed preset

---

Check the repo and tell me if it is correct

---

Give a prompt i can feed into cluade to analyze my repo and get back to me with a fix
